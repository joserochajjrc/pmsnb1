...
import 'package:pmsnb1/screens/pokemon_Details_Screen.dart';

class PokemonScrenn extends StatefulWidget {
  const PokemonScrenn({super.key});

  @override
  State<PokemonScrenn> createState() => _PokemonScrennState();
}

class _PokemonScrennState extends State<PokemonScrenn> {
                ...
                child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => PokemonDetailsScreen(heroTag: index, pokemonDetail: pokedex[index],
                        color: pokedex[index]['type'][0] == "Grass" ? Colors.greenAccent : pokedex[index]['type'][0] == "Fire" ? Colors.redAccent
                            : pokedex[index]['type'][0] == "Water" ? Colors.blue : pokedex[index]['type'][0] == "Poison" ? Colors.deepPurpleAccent
                            : pokedex[index]['type'][0] == "Electric" ? Colors.amber : pokedex[index]['type'][0] == "Rock" ? Colors.grey
                            : pokedex[index]['type'][0] == "Ground" ? Colors.brown : pokedex[index]['type'][0] == "Psychic" ? Colors.indigo
